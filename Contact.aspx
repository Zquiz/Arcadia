...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content" style="min-height: 536px">
        <div style="width: 451px; height: 536px; margin-top: 166px; margin-left: 139px; margin-bottom: 43px; float: left;">
            <div class="BE-A-PART-OF-THE-FUT">CONTACT FOR QUESTIONS</div>
            <div class="signupImage">
            </div>
        </div>
        <div style="height: 536px; margin-top: 186px; margin-left: 198px; float: left;">
        ...
        <div style="float: left; min-height: 536px; margin-top: 186px; margin-left: 21px;">
            ...
            <div style="margin-left: 212px; margin-top: 33px; margin-bottom: 37px;">
