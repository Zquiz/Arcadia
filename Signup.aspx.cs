...
public partial class Signup : Page
{
    ...
    private string highfileName = "";

    private string lowFileName = "";
    ...
    protected void DrawStepText()
    {
        ...
        switch (_step)
        {
            ...
            case 1:
                ...
                litHeader.Text +=
                    "<div class='Stepundertext'>Upload a picture of yoursef (selfie) with one high and one low carbon emitting product in your life</div>";
                litHeader.Text += "</div>";
                break;
    ...
    protected Tuple<string, string> ImageUpload()
    {
        ...
        {
            //high save method 
            var fileNameExtension = Path.GetExtension(upload.FileName);
            ...
            //low save method 
            var lowfileNameExtension = Path.GetExtension(upload2.FileName);
